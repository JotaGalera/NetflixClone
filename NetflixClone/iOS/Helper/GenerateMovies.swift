...
func generateMovies(_ count: Int) -> [Movie] {
    ...
    for _ in 0..<count {
        ...
        let movie = Movie(id: id, name: name, thumbnailURL: thumbnail, categories: categories, genre: .allGenres, year: year, rating: "PG-13", numberOfSeason:  numSeasons, currentEpisode: defEpiInfo, defaultEpisodeInfo: defEpiInfo, creator: creators, cast: cast, moreLikeThisMovies: moreLikeThis, episodes: allEpisodes, promotionalHeadling: headline, trailers: allTrailers, previewImageName: "")
